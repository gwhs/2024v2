...
public class GameRobotContainer implements BaseContainer {
  ...
  public GameRobotContainer() {
    ...
    SmartDashboard.putData(retractIntakePassToPB());
    SmartDashboard.putData(scoreSpeaker(160));
    SmartDashboard.putData(scoreSpeaker(230));
    SmartDashboard.putData(scoreAmp());
    SmartDashboard.putData(sourceIntake());
    SmartDashboard.putData(prepClimb());
    SmartDashboard.putData(climbAndScore());
    SmartDashboard.putData(unclimbPartOne());
    SmartDashboard.putData(unclimbPartTwo());

    /*
     * Put Command Scheduler and subsystems to shuffleboard
     */
    SmartDashboard.putData(CommandScheduler.getInstance());
    SmartDashboard.putData(m_PizzaBoxSubsystem);
    SmartDashboard.putData(m_ReactionSubsystem);
    SmartDashboard.putData(m_IntakeSubsystem);
    SmartDashboard.putData(m_ArmSubsystem);
    SmartDashboard.putData(m_ClimbSubsystem);
  }
