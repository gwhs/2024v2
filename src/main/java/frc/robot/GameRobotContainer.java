...
public class GameRobotContainer implements BaseContainer {
   ...
   closedFieldRel = new TeleopDrive(
        ...
        SetupShuffleboard.setupShuffleboard(m_drivebase, m_PizzaBoxSubsystem, closedFieldRel, m_ArmSubsystem, m_IntakeSubsystem, m_LimelightSubsystem, m_ClimbSubsystem, m_ReactionSubsystem, autoChooser);
