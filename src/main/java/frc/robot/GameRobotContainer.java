...
public class GameRobotContainer implements BaseContainer {
    ...
    public GameRobotContainer() {
        ...
        SetupShuffleboard.setupShuffleboard(/*m_drivebase,*/ m_PizzaBoxSubsystem, m_ArmSubsystem, m_IntakeSubsystem, /*m_LimelightSubsystem,*/ m_ClimbSubsystem, m_ReactionSubsystem, autoChooser, drive);
