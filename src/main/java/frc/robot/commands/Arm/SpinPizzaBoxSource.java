...
public class SpinPizzaBoxSource extends SequentialCommandGroup {
  /** Creates a new SpinPizzaBoxSource. */
  public SpinPizzaBoxSource(PizzaBoxSubsystem pizzaBoxSubsystem) {
