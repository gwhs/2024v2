...
public class ReactionSubsystem extends SubsystemBase {
  ...
  public ReactionSubsystem() {
    ...
    SmartDashboard.putData("Command Testing/Extend Reaction Bar", extendReactionBar());
    SmartDashboard.putData("Command Testing/Retract Reaction Bar", retractReactionBar());
  }
