...
public class ArmContainer implements BaseContainer {
    ...
    private final CommandXboxController m_driverController =
        ...
        //CAN_Network
        ArmSubsystem arm = new ArmSubsystem(0, "CAN_Network", 3, "rio", 0, 0); 
        //(int armId, String armCanbus, int pizzaBoxId, String pizzaBoxCanbus, int channel1, int channelServo)
